...
pub const datatable = hack.StructByteMap(.{
    ...
    .{ .{Node.L0Kind.heading2}, Rule.GenDef.def(&pre_anchored_heading2, "</a></h2>") },
    .{ .{Node.L0Kind.heading3}, Rule.GenDef.def(&pre_anchored_heading3, "</a></h3>") },
    .{ .{Node.L0Kind.heading4}, Rule.GenDef.def(&pre_anchored_heading4, "</a></h4>") },
    .{ .{Node.L0Kind.heading5}, Rule.GenDef.def(&pre_anchored_heading5, "</a></h5>") },
    .{ .{Node.L0Kind.heading6}, Rule.GenDef.def(&pre_anchored_heading6, "</a></h6>") },
